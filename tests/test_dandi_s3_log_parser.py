...
def test_parse_dandi_raw_s3_log_example_0(tmpdir: py.path.local):
    ...
    expected_parsed_s3_log_folder_path = examples_folder_path / "output"
    ...
    assert number_of_output_files != 0, f"Test output folder ({test_parsed_s3_log_folder_path}) is empty!"
