...
def test_map_reduced_logs_to_all_dandisets(tmpdir: py.path.local):
    ...
    reduced_s3_log_folder_path = examples_folder_path / "reduced_logs"
    all_dandiset_logs_folder_path = tmpdir

    dandi_s3_log_parser.map_reduced_logs_to_all_dandisets(
    ...
    test_dandiset_id_folder_paths = [
        dandiset_id_folder_path.stem for dandiset_id_folder_path in all_dandiset_logs_folder_path.iterdir()
    ]
    ...
    test_dandiset_version_id_file_paths = {
        ...
        for dandiset_id_folder_path in all_dandiset_logs_folder_path.iterdir()
    ...
    for expected_version_id_file_path in expected_dandiset_version_id_file_paths.values():
        test_version_id_file_path = (
            all_dandiset_logs_folder_path
            / expected_version_id_file_path.parent.name
            / expected_version_id_file_path.name
        )
