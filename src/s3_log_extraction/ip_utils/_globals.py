...
def is_github_actions_label(region_label: str | None, /) -> bool:
    """
    Determine whether a region/service label (as produced by a region resolver) refers to a GitHub Actions
    runner range.
